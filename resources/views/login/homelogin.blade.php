                            ...
                            <li class="cart-icon">
                                ...
                                <!--<div class="cart-hover">
                                    ...
                                    <div class="select-button">
                                        <a href="{{ url('login') }}" class="primary-btn view-card">VIEW CART</a>
                                        <a href="{{ url('login') }}" class="primary-btn checkout-btn">CHECK OUT</a>
                                    </div> 
                                </div>-->
                            </li>
            ...
            <div class="container">
                <div class="nav-depart">
                    <div class="depart-btn">
                        ...
                        <ul class="depart-hover">
                            <li class="active"><a href="{{ url('login') }}">Women’s Clothing</a></li>
                            <li><a href="{{ url('login') }}">Men’s Clothing</a></li>
                        </ul>
                    </div>
                </div>
                <nav class="nav-menu mobile-menu">
                    <ul>
                        ...
                        <li class="{{ (request()->is('shop*')) ? 'active' : '' }}"><a href="{{ url('login') }}">Shop</a></li>
                ...
                <div class="col-lg-3">
                    <div class="footer-left">
                        <div class="footer-logo">
                            <a href="{{ url('/') }}"><img src="{{ asset('/assets-user/img/footer-logo.png') }}" alt=""></a>
                        </div>
                        <ul>
                ...
                <div class="col-lg-2 offset-lg-1">
                    <div class="footer-widget">
                        ...
                        <ul>
                            ...
                            <li><a href="{{ url('login') }}">Checkout</a></li>
                ...
                <div class="col-lg-2">
                    <div class="footer-widget">
                        ...
                        <ul>
                            ...
                            <li><a href="{{ url('contact') }}">Contact</a></li>
                            <li><a href="{{ url('login') }}">Shopping Cart</a></li>

...
<div class="container my-3">
  @if (session('status'))
    <div class="col-lg-8 mx-auto mt-3 alert alert-{{ session('type') }} alert-dismissible fade show" role="alert">
      {{ session('status') }}
  ...
  <div class="card col-lg-8 mx-auto text-center">
    <div class="card-body">
      ...
      <h6 class="card-subtitle mb-2 text-muted">Terima kasih telah mempercayai kami.</h6>
      @if($transaction->proof_of_payment === 'Belum Dibayar')
        ...
        <div class="my-2" id="getting-started"></div>
          ...
          <a href="/users/cancel/transaction/{{$transaction->id}}" class="btn btn-link">Batal</a>
      @else
